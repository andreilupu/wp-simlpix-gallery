...
class Simlpix_Gallery {
	 ...
	 * @var      string
	 */
	protected $plugin_slug = 'simlpix-gallery';
	...
	private function __construct() {
		...
		// $plugin_basename = plugin_basename( plugin_dir_path( __FILE__ ) . 'simlpix-gallery.php' );
	...
	public function add_plugin_admin_menu() {
		 ...
		 * Change 'simlpix-gallery' to the name of your plugin
		 */
	...
	public function add_action_links( $links ) {
		...
		return array_merge(
			array(
				'settings' => '<a href="' . admin_url( 'plugins.php?page=simlpix-gallery' ) . '">' . __( 'Settings', $this->plugin_slug ) . '</a>'
			),
			$links
		);
